...
export class CreateUsers1778437063655 implements MigrationInterface {
    name = 'CreateUsers1778437063655'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'author', 'user')`);
